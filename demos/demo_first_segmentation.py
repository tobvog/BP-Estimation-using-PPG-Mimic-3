...
path_main = "D:/MIMICIII_Database/mimic3wdb-1.0.physionet.org/"
# Target path
path_target = "D:/MIMICIII_Database/segmented_data_slapnicar/"
    ...
    for i in range(30,40):
        ...
        for j in range(1,10):
            ...
            if sorting_.check_existence(path_name) == True:
                first_loop(path_name,i,j,add,path_main)
        ...
        if i == 30:
            ...
            for j in range(1,10):
                ...
                if sorting_.check_existence(path_name_new) == True and sorting_.check_existence(path_name_old) == False:
                    first_loop(path_name_new,i,j,add,path_main)  
